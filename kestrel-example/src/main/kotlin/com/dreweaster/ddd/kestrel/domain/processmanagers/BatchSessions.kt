...
// correlationIdSelector is only necessary for mapping external events - i.e. events not generated by the event manager itself
...
//   2. Then trigger processing straight away = domainModel.processManagerOf(BatchSessions).instanceOf(id).event() (using the correlation id returned above)
            ...
            behaviour<Empty> {
                ...
                event<ParkingSessionQueued> { cxt, _, evt ->
                    goto(Buffering(
                        ...
                        .andSend { RegisterUser(it.first,it.second) toAggregate User identifiedBy AggregateId() }
...
interface DomainModel {
    ...
    // As a way to trigger the processing of event managers with outstanding events to event
